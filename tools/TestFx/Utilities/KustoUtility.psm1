    ...
    try {
        ...
        $CsvFile | ForEach-Object {
            ...
            try {
                ...
                Write-Host "##[error]Error occurred when ingesting test coverage data to Kusto."
                Write-Host "##[error]Error Message: $($_.Exception.Message)"
                Write-Host "##[error]Error Stack Trace: $($_.Exception.StackTrace)"
