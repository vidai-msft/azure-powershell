...
### Example 1: Get the list of all traffic filters for the given monitor
```powershell
...
Get the list of all traffic filters for the given monitor.

### Example 2: Get the list of all traffic filters for the given monitor via pipeline
```powershell
...
Get the list of all traffic filters for the given monitor via pipeline.
...
### Microsoft.Azure.PowerShell.Cmdlets.Elastic.Models.Api20230601.IElasticTrafficFilter
